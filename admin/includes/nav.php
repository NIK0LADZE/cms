            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="/cms/actions/logout.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
                    ...
                    <?php if($_SESSION["role"] === "Admin" || $_SESSION["role"] === "Moderator") { ?>
                        <li>
                            ...
                            <ul id="posts" class="collapse">
                                <li>
                                    <a href="posts.php?action=view"><i class="fa fa-fw fa-table"></i>&nbsp;View All Posts</a>
                                </li>
                                <li>
                                    <a href="posts.php?action=add"><i class="fas fa-folder-plus"></i>&nbsp;&nbsp;Add Post</a>
                                </li>
                            </ul>
                        </li>
                        <?php } else { ?>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.nav.navbar-nav.side-nav li a[href="'+activeurl[activeurl.length - 1]+'"]').parent('li').addClass('active');
                if(activeurl[activeurl.length - 1] == "") {
                    $('.nav.navbar-nav.side-nav li a[href="index.php"]').parent('li').addClass('active');
                }
            })
        </script>
